...
class Detector:
    def __init__(self, pnet_param=r"./param_widerface/p_r_o0515fine/pnet.pt",
                 rnet_param="./param_widerface/p_r_o0515fine/rnet.pt",
                 onet_param="./param_widerface/p_r_o0515fine/onet.pt",
                 isCuda=True):
        self.isCuda = isCuda
