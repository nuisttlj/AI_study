...
class Detector:
    def __init__(self, pnet_param=r"./param_widerface/test weight/pnet.pt",
                 rnet_param="./param_widerface/test weight/rnet.pt",
                 onet_param="./param_widerface/test weight/onet.pt",
                 isCuda=True):
        self.isCuda = isCuda
