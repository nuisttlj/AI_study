...
mydata = make_picdataset.MyDataset("compounds_pic", 32)
...
class CNNNet:
    ...
    def backword(self):
        self.op = tf.train.AdamOptimizer(0.00001).minimize(self.loss)
...
with tf.Session() as sess:
    ...
    for i in range(1000):
        ...
        saver.save(sess, "./yellow_param02/findyellow_model.ckpt")
        # if i % 5 == 0:
